...
public class Client extends RSApplet {
	...
	public boolean hitMarkToggle = true, HPBarToggle = true;
	...
	public void drawChannelButtons() {
		final int yOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientHeight - 165;
	...
	private boolean chatStateCheck() {
		return messagePromptRaised || inputDialogState != 0
				|| aString844 != null || backDialogID != -1 || dialogID != -1;
	}

	private void drawChatArea() {
		int yOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientHeight - 165;
		...
		if (!showChatComponents || changeChatArea) {
			DrawingArea.drawAlphaPixels(7, Configuration.clientHeight - 23,
					506, 24, 0, 100);
		}
		drawChannelButtons();
		TextDrawingArea textDrawingArea = aTextDrawingArea_1271;
		if (super.saveClickX >= 0
				&& super.saveClickX <= 522
				&& super.saveClickY >= (Configuration.clientSize == 0 ? 343
						: Configuration.clientHeight - 165)
				&& super.saveClickY <= (Configuration.clientSize == 0 ? 484
						: Configuration.clientHeight - 27)) {
		...
		if (messagePromptRaised) {
			...
			newBoldFont
					.drawCenteredString(aString844, 259, 60 + yOffset, 0, -1);
						...
						if (chatTypeView == 1 || chatTypeView == 0) {
							if (yPos > 0 && yPos < 210) {
								...
								if (byte0 == 1) {
									...
									modIcons[9].drawSprite(xPos + 1, yPos - 12
											+ yOffset);
									xPos += 14;
								} else if (byte0 == 11) {
									modIcons[10].drawSprite(xPos + 1, yPos - 12
											+ yOffset);
									xPos += 14;
								}
			...
			DrawingArea.setDrawingArea(140 + yOffset, 8, 519, 120 + yOffset);
			int xOffset = 0;
			if (!changeChatArea) {
				textDrawingArea.method385(0, s + ":", 133 + yOffset,
						11 + xOffset);
			} else {
				textDrawingArea.drawChatInput(0xFFFFFF, 11 + xOffset, s + ":",
						133 + yOffset, true);
			}
			textDrawingArea.drawChatInput(changeChatArea ? 0x7FA9FF : 255, 12
					+ textDrawingArea.getTextWidth(s + ": ") + xOffset,
					inputString + "*", 133 + yOffset, changeChatArea ? true
							: false);
			DrawingArea.drawHorizontalLine(7, 121 + yOffset, 520,
					changeChatArea ? 0xFFFFFF : 0x807660, changeChatArea ? 120
							: 255);
			DrawingArea.defaultDrawingAreaSize();
		}
	...
	public Socket openSocket(int port) throws IOException {
		return new Socket(InetAddress.getByName(Configuration.clientMode
				.getAddress()), Configuration.clientMode.getPort());
	}
	...
	private final void minimapHovers() {
		...
		hpHover = fixed ? super.mouseX >= 690 && super.mouseX <= 745
				&& super.mouseY >= 13 && super.mouseY < 47
				: super.mouseX >= Configuration.clientWidth - 216
						&& super.mouseX <= 159 && super.mouseY >= 13
						&& super.mouseY < 47;
		prayHover = fixed ? super.mouseX >= 518 && super.mouseX <= 574
				&& super.mouseY >= 86 && super.mouseY < 118
				: super.mouseX >= Configuration.clientWidth - 211
						&& super.mouseX <= Configuration.clientWidth - 154
						&& super.mouseY >= 86 && super.mouseY < 120;
		runHover = fixed ? super.mouseX >= 543 && super.mouseX <= 600
				&& super.mouseY >= 123 && super.mouseY < 154
				: super.mouseX >= Configuration.clientWidth - 187
						&& super.mouseX <= Configuration.clientWidth - 128
						&& super.mouseY >= 121 && super.mouseY < 156;
		counterHover = fixed ? super.mouseX >= 516 && super.mouseX <= 542
				&& super.mouseY >= 20 && super.mouseY <= 46
				: super.mouseX >= Configuration.clientWidth - 215
						&& super.mouseX <= Configuration.clientWidth - 188
						&& super.mouseY >= 10 && super.mouseY < 36;
		worldHover = fixed ? super.mouseX >= 718 && super.mouseX <= 748
				&& super.mouseY >= 22 && super.mouseY <= 50
				: super.mouseX >= Configuration.clientWidth - 117
						&& super.mouseX <= Configuration.clientWidth - 86
						&& super.mouseY >= 153 && super.mouseY <= 186;
		starHover = fixed ? super.mouseX >= 529 && super.mouseX <= 544
				&& super.mouseY >= 146 && super.mouseY <= 157
				: super.mouseX >= Configuration.clientWidth - 755
						&& super.mouseX <= Configuration.clientWidth - 769
						&& super.mouseY >= 172 && super.mouseY <= 182;
		specialHover = fixed ? super.mouseX >= 687 && super.mouseX <= 743
				&& super.mouseY >= 123 && super.mouseY <= 154
				: super.mouseX >= Configuration.clientWidth - 62
						&& super.mouseX <= Configuration.clientWidth
	...
	public int getOrbX(int orb) {
		switch (orb) {
		case 0:
			return Configuration.clientSize != 0 ? Configuration.clientWidth - 212
					: 172;
		case 1:
			return Configuration.clientSize != 0 ? Configuration.clientWidth - 210
					: 190;
		case 2:
			return Configuration.clientSize != 0 ? Configuration.clientWidth - 198
					: 190;
		case 3:
			return Configuration.clientSize != 0 ? Configuration.clientWidth - 176
					: 174;
		case 4:
			return Configuration.clientSize != 0 ? Configuration.clientWidth - 208
					: 174;
		}
		return 0;
	}
	...
	public int getOrbY(int orb) {
		switch (orb) {
		case 0:
			return Configuration.clientSize != 0 ? 39 : 15;
		case 1:
			return Configuration.clientSize != 0 ? 74 : 53;
		case 2:
			return Configuration.clientSize != 0 ? 108 : 93;
		case 3:
			return Configuration.clientSize != 0 ? 139 : 127;
		case 4:
			return Configuration.clientSize != 0 ? 39 : 14;
		}
		return 0;
	}
	...
	private int cButtonHPos, cButtonCPos, channel;
	public boolean showChat = true;

	public void processChatModeClick() {
		final int yOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientHeight - 503;
		...
		if (super.clickMode3 == 1) {
			if (super.saveClickX >= 5 && super.saveClickX <= 61
				...
				if (Configuration.clientSize != 0) {
					...
					&& super.saveClickY <= yOffset + 505) {
				if (Configuration.clientSize != 0) {
					if (channel != 1 && Configuration.clientSize != 0) {
						cButtonCPos = 1;
						chatTypeView = 5;
						inputTaken = true;
						channel = 1;
					...
					&& super.saveClickY <= yOffset + 505) {
				if (Configuration.clientSize != 0) {
					if (channel != 2 && Configuration.clientSize != 0) {
						cButtonCPos = 2;
						chatTypeView = 1;
						inputTaken = true;
						channel = 2;
					...
					&& super.saveClickY <= yOffset + 505) {
				if (Configuration.clientSize != 0) {
					if (channel != 3 && Configuration.clientSize != 0) {
						cButtonCPos = 3;
						chatTypeView = 2;
						inputTaken = true;
						channel = 3;
					...
					&& super.saveClickY <= yOffset + 505) {
				if (Configuration.clientSize != 0) {
					if (channel != 4 && Configuration.clientSize != 0) {
						cButtonCPos = 4;
						chatTypeView = 11;
						inputTaken = true;
						channel = 4;
					...
					&& super.saveClickY <= yOffset + 505) {
				if (Configuration.clientSize != 0) {
					if (channel != 5 && Configuration.clientSize != 0) {
						cButtonCPos = 5;
						chatTypeView = 3;
						inputTaken = true;
						channel = 5;
				...
				if (!Configuration.hitmarks554) {
					for (int j1 = 0; j1 < 4; j1++) {
						if (((Entity) (obj)).hitsLoopCycle[j1] > loopCycle) {
							...
							if (spriteDrawX > -1) {
								if (j1 == 0
										&& ((Entity) (obj)).hitArray[j1] > 99)
									((Entity) (obj)).hitMarkTypes[j1] = 5;
								else if (j1 == 1
										&& ((Entity) (obj)).hitArray[j1] > 99)
									((Entity) (obj)).hitMarkTypes[j1] = 5;
								else if (j1 == 2
								...
								if (((Entity) (obj)).hitMarkTypes[j1] == 5) {
									spriteDrawX -= 4;
								}
								...
								smallText
										.drawText(
												...
												spriteDrawY + 5,
												(((Entity) (obj)).hitMarkTypes[j1] == 5 ? spriteDrawX + 5
														: spriteDrawX));
								smallText
										.drawText(
												0xffffff,
												String.valueOf(((Entity) (obj)).hitArray[j1]),
												spriteDrawY + 4,
												(((Entity) (obj)).hitMarkTypes[j1] == 5 ? spriteDrawX + 4
														: spriteDrawX - 1));
							}
						}
					}
							...
							if (spriteDrawX > -1) {
								...
								smallText
										.drawText(
												...
												spriteDrawY + 5,
												(((Entity) (obj)).hitMarkTypes[j2] == 3 ? spriteDrawX + 8
														: spriteDrawX));
								smallText
										.drawText(
												0xffffff,
	...
	public void drawSideIcons() {
		int xOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientWidth - 247;
		int yOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientHeight - 336;
		if (Configuration.clientSize == 0 || Configuration.clientSize != 0
				&& !changeTabArea) {
			...
			for (int i = 0; i < sideIconsTab.length; i++) {
				if (tabInterfaceIDs[sideIconsTab[i]] != -1) {
					if (iconId[i] != -1) {
						sideIcons[iconId[i]].drawSprite(
								Configuration.clientWidth - iconX[i],
			...
			for (int i = 0; i < sideIconsTab.length; i++) {
				if (tabInterfaceIDs[sideIconsTab[i]] != -1) {
					if (iconId[i] != -1) {
						sideIcons[iconId[i]].drawSprite(
								Configuration.clientWidth - 461 + iconX[i],
								Configuration.clientHeight - iconY[i]);
					}
				}
			}
	...
	private void drawRedStones() {
		...
		if (Configuration.clientSize == 0 || Configuration.clientSize != 0
			...
			if (tabInterfaceIDs[tabID] != -1 && tabID != 10
					&& showTabComponents) {
				if (tabID == 7) {
					cacheSprite[39].drawSprite(Configuration.clientWidth - 130,
							Configuration.clientHeight - 37);
				}
				cacheSprite[39].drawSprite(Configuration.clientWidth
						- stoneX[tabID], Configuration.clientHeight
						- stoneY[tabID]);
			}
		} else if (changeTabArea && Configuration.clientWidth >= 1000) {
			...
			if (tabInterfaceIDs[tabID] != -1 && tabID != 10
					&& showTabComponents) {
				cacheSprite[39].drawSprite(Configuration.clientWidth
						- stoneX[tabID], Configuration.clientHeight - 37);
			}
		}
	}

	private void drawTabArea() {
		// InventoryTab.drawGraphics(168, super.graphics, 516);
		final int xOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientWidth - 241;
		final int yOffset = Configuration.clientSize == 0 ? 0
				: Configuration.clientHeight - 336;
		if (Configuration.clientSize == 0) {
		...
		if (Configuration.clientSize == 0) {
			...
			DrawingArea.method335(0x3E3529, Configuration.clientHeight - 304,
					195, 270, transparentTabArea ? 80 : 256,
			...
			if (Configuration.clientWidth >= 1000) {
				if (showTabComponents) {
					DrawingArea.method335(0x3E3529,
							Configuration.clientHeight - 304, 197, 265,
							transparentTabArea ? 80 : 256,
							Configuration.clientWidth - 197);
					cacheSprite[50].drawSprite(Configuration.clientWidth - 204,
							Configuration.clientHeight - 311);
				}
				for (int x = Configuration.clientWidth - 417, y = Configuration.clientHeight - 37, index = 0; x <= Configuration.clientWidth - 30
						&& index < 13; x += 32, index++) {
				...
				if (showTabComponents) {
					DrawingArea.method335(0x3E3529,
							Configuration.clientHeight - 341, 195, 265,
							transparentTabArea ? 80 : 256,
							Configuration.clientWidth - 197);
					cacheSprite[50].drawSprite(Configuration.clientWidth - 204,
							Configuration.clientHeight - 348);
				}
				for (int x = Configuration.clientWidth - 226, y = Configuration.clientHeight - 73, index = 0; x <= Configuration.clientWidth - 32
						&& index < 7; x += 32, index++) {
					cacheSprite[46].drawSprite(x, y);
				}
				for (int x = Configuration.clientWidth - 226, y = Configuration.clientHeight - 37, index = 0; x <= Configuration.clientWidth - 32
						&& index < 7; x += 32, index++) {
					cacheSprite[46].drawSprite(x, y);
				}
			}
		...
		if (showTabComponents) {
			int x = Configuration.clientSize == 0 ? 31
					: Configuration.clientWidth - 215;
			int y = Configuration.clientSize == 0 ? 37
					: Configuration.clientHeight - 299;
			if (changeTabArea) {
			...
			if (invOverlayInterfaceID != -1) {
				drawInterface(0, x,
						RSInterface.interfaceCache[invOverlayInterfaceID], y);
		...
		if (menuOpen) {
			drawMenu(Configuration.clientSize == 0 ? 516 : 0,
					Configuration.clientSize == 0 ? 168 : 0);
		}
		if (Configuration.clientSize == 0) {
	...
	void drawMenu(int xOffSet, int yOffSet) {
		if (!Configuration.newMenu) {
			int xPos = menuOffsetX - (xOffSet - 0);
			int yPos = (-yOffSet + 0) + menuOffsetY;
			int menuW = menuWidth;
			...
			DrawingArea.fillPixels(xPos + 1, menuW - 2, menuH - 19, 0,
					yPos + 18);
			chatTextDrawingArea.method385(0x5d5447, "Choose Option", yPos + 18,
					xPos + 3);
			int mouseX = super.mouseX - (xOffSet);
			int mouseY = (-yOffSet) + super.mouseY;
			for (int l1 = 0; l1 < menuActionRow; l1++) {
				int textY = yPos + 35 + (menuActionRow - 1 - l1) * 15;
				int color = 0xffffff;
				if (mouseX > xPos && mouseX < xPos + menuW
						&& mouseY > textY - 13 && mouseY < textY + 3) {
					color = 0xffff00;
					newBoldFont.drawBasicString(menuActionName[l1], xPos + 3,
							textY, color, 0);
				}
				newBoldFont.drawBasicString(menuActionName[l1], xPos + 3,
						textY, color, 0);
				// chatTextDrawingArea.method389(true, xPos + 3, color,
		...
		if (Configuration.newMenu) {
			...
			chatTextDrawingArea.method385(0xc6b895, "Choose Option", yPos + 18,
					xPos + 3);
			int mouseX = super.mouseX - (xOffSet);
			int mouseY = (-yOffSet) + super.mouseY;
			for (int l1 = 0; l1 < menuActionRow; l1++) {
				...
				if (mouseX > xPos && mouseX < xPos + menuW
						&& mouseY > textY - 13 && mouseY < textY + 3) {
					DrawingArea.drawPixels(15, textY - 15, xPos + 3, 0x6f695d,
							menuWidth - 6);
					disColor = 0xeee5c6;
				}
				newBoldFont.drawBasicString(menuActionName[l1], xPos + 3,
	...
	public static boolean changeTabArea = Configuration.clientSize == 0 ? false
			: true;
	public static boolean changeChatArea = Configuration.clientSize == 0 ? false
			: true;
	...
	public void checkSize() {
		if (Configuration.clientSize == 1) {
			if (Configuration.clientWidth != (isWebclient() ? getGameComponent()
					.getWidth() : gameFrame.getFrameWidth())) {
				Configuration.clientWidth = (isWebclient() ? getGameComponent()
						.getWidth() : gameFrame.getFrameWidth());
				gameAreaWidth = Configuration.clientWidth;
				updateGame();
			}
			if (Configuration.clientHeight != (isWebclient() ? getGameComponent()
					.getHeight() : gameFrame.getFrameHeight())) {
				Configuration.clientHeight = (isWebclient() ? getGameComponent()
						.getHeight() : gameFrame.getFrameHeight());
	...
	private void updateGame() {
		try {
			Texture.method365(Configuration.clientWidth,
					Configuration.clientHeight);
			fullScreenTextureArray = Texture.lineOffsets;
			Texture.method365(
					Configuration.clientSize == 0 ? (chatAreaIP != null ? chatAreaIP.width
							: 516)
							: Configuration.clientWidth,
					Configuration.clientSize == 0 ? (chatAreaIP != null ? chatAreaIP.height
							: 165)
							: Configuration.clientHeight);
			anIntArray1180 = Texture.lineOffsets;
			Texture.method365(
					Configuration.clientSize == 0 ? (tabAreaIP != null ? tabAreaIP.width
							: 249)
							: Configuration.clientWidth,
					Configuration.clientSize == 0 ? (tabAreaIP != null ? tabAreaIP.height
							: 335)
							: Configuration.clientHeight);
			anIntArray1181 = Texture.lineOffsets;
			Texture.method365(!loggedIn ? Configuration.clientWidth
					: gameAreaWidth, !loggedIn ? Configuration.clientHeight
					: gameAreaHeight);
			...
			if (Configuration.clientSize == 1
					&& (Configuration.clientWidth >= 756)
					&& (Configuration.clientWidth <= 1025)
					&& (Configuration.clientHeight >= 494)
					&& (Configuration.clientHeight <= 850)) {
				WorldController.viewDistance = 9;
				cameraZoom = 575;
			...
			if (loggedIn) {
				...
				titleScreen = new RSImageProducer(Configuration.clientWidth,
						Configuration.clientHeight, getGameComponent());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void main(String args[]) {
		try {
			Configuration.clientMode = ClientMode.LIVE;
			if (args.length > 0) {
				switch (args[0].toLowerCase()) {
				case "local":
					Configuration.clientMode = ClientMode.LOCAL;
					break;
				}
			}
			System.out.println("AbyssalPS ~ Official Client");
			nodeID = 10;
			portOff = 0;
			setHighMem();
			isMembers = true;
			...
			SignLink.startpriv(InetAddress.getLocalHost());
			instance = new Client();
			instance.createClientFrame(Configuration.clientWidth,
					Configuration.clientHeight);
		} catch (Exception exception) {
		}
	}
		...
		do {
			...
			do {
				...
				if (onDemandData.dataType == 1
					...
					Class36.decode(onDemandData.ID, onDemandData.buffer);
				}
	...
	public void resetImageProducers() {
		...
		aRSImageProducer_1107 = new RSImageProducer(509, 171,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		titleScreen = new RSImageProducer(765, 503, getGameComponent());
		DrawingArea.setAllPixelsToZero();
	...
	/*
	 * private void resetImageProducers() { if(aRSImageProducer_1107 != null)
	 * return; super.fullGameScreen = null; chatAreaIP = null; mapAreaIP = null;
	 * tabAreaIP = null; gameScreenIP = null; aRSImageProducer_1125 = null;
	 * aRSImageProducer_1110 = new RSImageProducer(128, 265,
	 ...
	 * getGameComponent()); DrawingArea.setAllPixelsToZero(); titleScreen = new
	 * RSImageProducer(360, 200, getGameComponent());
	 * DrawingArea.setAllPixelsToZero(); aRSImageProducer_1112 = new
	 * RSImageProducer(202, 238, getGameComponent());
	 * DrawingArea.setAllPixelsToZero(); aRSImageProducer_1113 = new
	 * RSImageProducer(203, 238, getGameComponent());
	 * DrawingArea.setAllPixelsToZero(); aRSImageProducer_1114 = new
	 * RSImageProducer(74, 94, getGameComponent());
	 * DrawingArea.setAllPixelsToZero(); aRSImageProducer_1115 = new
	 * RSImageProducer(75, 94, getGameComponent());
	 * DrawingArea.setAllPixelsToZero(); if(titleStreamLoader != null) {
	 * drawLogo(); loadTitleScreen(); } welcomeScreenRaised = true; }
	 */
	...
	private void doAction(int i) {
		...
		if (identity >= 1700 && identity <= 1710) {
			stream.createFrame(185);
			int offset = 0;
			offset = k + (k - 58030) * 10 + (identity - 1700);
		...
		if (identity == 1506) { // Select quick prayers
			stream.createFrame(185);
			stream.writeWord(5001);
		}
		if (identity == 1500) { // Toggle quick prayers
				...
				if (itemSelected == 1) {
					...
					if (!debugModels)
						menuActionName[menuActionRow] = "Examine @cya@"
								...
								+ "@gre@) (@whi@" + (i1 + baseX) + ","
								+ (j1 + baseY) + "@gre@)";
					else if (class46.actions != null)
						menuActionName[menuActionRow] = "Examine @cya@"
								+ class46.name + "Models: @gre@(@whi@" + l1
								+ "@gre@) (@whi@" + (i1 + baseX) + ","
								+ (j1 + baseY) + "@gre@)"
								+ Arrays.toString(class46.actions);
		...
		do {
			...
			if (openInterfaceID != -1
				...
				if (this.isFieldInFocus()) {
					...
					if (rsi.isItemSearchComponent && rsi.message.length() > 2
					...
					} else if (rsi.updatesEveryInput
							&& rsi.message.length() > 0 && j != 10 && j != 13) {
						...
						promptInput = "";
						break;
					} else if ((j == 10 || j == 13) && rsi.message.length() > 0
							&& !rsi.updatesEveryInput) {
						stream.createFrame(142);
						stream.writeWordBigEndian(4 + rsi.message.length() + 1);
						stream.writeDWord(rsi.id);
						stream.writeString(rsi.message);
	...
	private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
		...
		if (j == 327) {
			...
			if (aBoolean1031) {
				...
				model.method469();
				model.method470(Animation.anims[myPlayer.anInt1511].frameIDs[0]);
		...
		if (j == 328) {
			...
			if (aBoolean1031) {
				...
				characterDisplay
						.method470(Animation.anims[staticFrame].frameIDs[0]);
		...
		if (super.clickMode3 == 1) {
			if (Configuration.clientSize == 0 || Configuration.clientSize != 0
				...
				if (super.saveClickX >= Configuration.clientWidth - 226
						...
						&& super.saveClickY < Configuration.clientHeight - 40
						&& tabInterfaceIDs[0] != -1) {
					if (tabID == 0) {
				...
				if (super.saveClickX >= Configuration.clientWidth - 33
						&& super.saveClickX <= Configuration.clientWidth
						&& super.saveClickY >= Configuration.clientHeight - 72
						&& super.saveClickY < Configuration.clientHeight - 40
						&& tabInterfaceIDs[6] != -1) {
					if (tabID == 6) {
				...
				if (super.saveClickX >= Configuration.clientWidth - 194
						...
						&& super.saveClickY < Configuration.clientHeight - 0
						&& tabInterfaceIDs[8] != -1) {
					if (tabID == 8) {
						showTabComponents = !showTabComponents;
					} else {
				...
				if (super.mouseY >= Configuration.clientHeight - 37
						&& super.mouseY <= Configuration.clientHeight) {
					...
					if (super.mouseX >= Configuration.clientWidth - 31
							&& super.mouseX <= Configuration.clientWidth) {
						if (tabID == 13) {
							showTabComponents = !showTabComponents;
						} else {
	...
	private void resetImageProducers2() {
		...
		gameScreenIP = new RSImageProducer(Configuration.clientSize == 0 ? 512
				: Configuration.clientWidth,
				Configuration.clientSize == 0 ? 334
						: Configuration.clientHeight, getGameComponent());
		DrawingArea.setAllPixelsToZero();
	...
	public void rightClickChatButtons() {
		if (mouseY >= Configuration.clientHeight - 22
				&& mouseY <= Configuration.clientHeight) {
			if (super.mouseX >= 5 && super.mouseX <= 61) {
	...
	public boolean getMousePositions() {
		if (mouseInRegion(Configuration.clientWidth
				- (Configuration.clientWidth <= 1000 ? 240 : 420),
				Configuration.clientHeight
						- (Configuration.clientWidth <= 1000 ? 90 : 37),
				Configuration.clientWidth, Configuration.clientHeight)) {
			return false;
		}
		if (showChatComponents) {
			if (changeChatArea) {
				if (super.mouseX > 0 && super.mouseX < 494
						&& super.mouseY > Configuration.clientHeight - 175
						&& super.mouseY < Configuration.clientHeight) {
					return true;
				} else {
		...
		if (mouseInRegion(Configuration.clientWidth - 216, 0,
				Configuration.clientWidth, 172)) {
			return false;
		}
		if (!changeTabArea) {
			if (super.mouseX > 0 && super.mouseY > 0
					&& super.mouseY < Configuration.clientWidth
					&& super.mouseY < Configuration.clientHeight) {
				if (super.mouseX >= Configuration.clientWidth - 242
						&& super.mouseY >= Configuration.clientHeight - 335) {
					return false;
				}
				return true;
			}
		...
		if (showTabComponents) {
			if (Configuration.clientWidth > 1000) {
				if (super.mouseX >= Configuration.clientWidth - 420
						&& super.mouseX <= Configuration.clientWidth
						&& super.mouseY >= Configuration.clientHeight - 37
						&& super.mouseY <= Configuration.clientHeight
						|| super.mouseX > Configuration.clientWidth - 225
						&& super.mouseX < Configuration.clientWidth
						&& super.mouseY > Configuration.clientHeight - 37 - 274
						&& super.mouseY < Configuration.clientHeight) {
					return false;
				}
			} else {
				if (super.mouseX >= Configuration.clientWidth - 210
						&& super.mouseX <= Configuration.clientWidth
						&& super.mouseY >= Configuration.clientHeight - 74
						&& super.mouseY <= Configuration.clientHeight
						|| super.mouseX > Configuration.clientWidth - 225
						&& super.mouseX < Configuration.clientWidth
						&& super.mouseY > Configuration.clientHeight - 74 - 274
						&& super.mouseY < Configuration.clientHeight) {
					return false;
				}
			}
	...
	public boolean mouseMapPosition() {
		if (super.mouseX >= Configuration.clientWidth - 21
				&& super.mouseX <= Configuration.clientWidth
	...
	public void processRightClick() {
		...
		if (Configuration.clientSize == 0) {
			...
			if (getMousePositions()) {
				if (super.mouseX > (Configuration.clientWidth / 2) - 356
						&& super.mouseY > (Configuration.clientHeight / 2) - 230
						&& super.mouseX < ((Configuration.clientWidth / 2) + 356)
						&& super.mouseY < (Configuration.clientHeight / 2) + 230
						&& openInterfaceID != -1) {
					buildInterfaceMenu((Configuration.clientWidth / 2) - 356,
							RSInterface.interfaceCache[openInterfaceID],
							super.mouseX,
							(Configuration.clientHeight / 2) - 230,
							super.mouseY, 0);
				} else {
					build3dScreenMenu();
				}
		...
		if (!changeTabArea) {
			...
			if (super.mouseX > Configuration.clientWidth - 197
					&& super.mouseY > Configuration.clientHeight - yOffset
							- 267
					&& super.mouseX < Configuration.clientWidth - 7
					&& super.mouseY < Configuration.clientHeight - yOffset - 7
					&& showTabComponents) {
				if (invOverlayInterfaceID != -1) {
					buildInterfaceMenu(Configuration.clientWidth - 197,
							RSInterface.interfaceCache[invOverlayInterfaceID],
							super.mouseX, Configuration.clientHeight - yOffset
									- 267, super.mouseY, 0);
				} else if (tabInterfaceIDs[tabID] != -1) {
					buildInterfaceMenu(Configuration.clientWidth - 197,
							RSInterface.interfaceCache[tabInterfaceIDs[tabID]],
		...
		anInt1315 = 0;
		if (super.mouseX > 0
				&& super.mouseY > (Configuration.clientSize == 0 ? 338
						: Configuration.clientHeight - 165)
				&& super.mouseX < 490
				&& super.mouseY < (Configuration.clientSize == 0 ? 463
						: Configuration.clientHeight - 40)
				&& showChatComponents) {
			if (backDialogID != -1) {
				buildInterfaceMenu(20,
						RSInterface.interfaceCache[backDialogID], super.mouseX,
						(Configuration.clientSize == 0 ? 358
								: Configuration.clientHeight - 145),
						super.mouseY, 0);
			} else if (super.mouseY < (Configuration.clientSize == 0 ? 463
					: Configuration.clientHeight - 40) && super.mouseX < 490) {
				buildChatAreaMenu(super.mouseY
						- (Configuration.clientSize == 0 ? 338
								: Configuration.clientHeight - 165));
			}
		}
	...
	void startUp() {
		...
		try {
			...
			for (int i = 0; i < Skills.skillsCount; i++) {
				skill_sprites[i] = new Sprite("skill/" + (95 + i));
			}
			for (int l4 = 0; l4 < 8; l4++)
				modIcons[l4] = new Sprite(streamLoader_2, "mod_icons", l4);
			for (int i = 0; i < inputSprites.length; i++)
				inputSprites[i] = new Sprite("Interfaces/Inputfield/SPRITE "
						+ (i + 1));
			...
			/*
			 * Texture.method365(765, 503); fullScreenTextureArray =
			 * Texture.lineOffsets; Texture.method365(516, 165); anIntArray1180
			 * = Texture.lineOffsets; Texture.method365(250, 335);
			 * anIntArray1181 = Texture.lineOffsets; Texture.method365(512,
			 * 334); anIntArray1182 = Texture.lineOffsets; int ai[] = new
			 * int[9]; for(int i8 = 0; i8 < 9; i8++) { int k8 = 128 + i8 * 32 +
			 * 15; int l8 = 600 + k8 * 3; int i9 = Texture.anIntArray1470[k8];
			 * ai[i8] = l8 * i9 >> 16; } WorldController.method310(500, 800,
			 * 512, 334, ai);
			 */
	...
	public void loadNewObjects() {
		addObject(6162, 3084, 3488, 1, 10, 0);
		addObject(6163, 3084, 3490, 1, 10, 0);
		addObject(6164, 3084, 3492, 1, 10, 0);
		addObject(6165, 3084, 3494, 1, 10, 0);
		addObject(6166, 3084, 3496, 1, 10, 0);
		addObject(24150, 3084, 3502, 1, 10, 0);
		addObject(1276, 2516, 4785, 1, 10, 0);
		addObject(11756, 2513, 4782, 1, 10, 0);
		addObject(11755, 2512, 4780, 1, 10, 0);
		addObject(11762, 2512, 4778, 1, 10, 0);
		addObject(11758, 2511, 4773, 1, 10, 0);
		addObject(11764, 2513, 4771, 1, 10, 0);
		addObject(11744, 2525, 4777, 1, 10, 0);
		addObject(13712, 2542, 4780, 1, 10, 0);
		addObject(13708, 2542, 4779, 1, 10, 0);
		addObject(13710, 2542, 4778, 1, 10, 0);
		addObject(13714, 2542, 4777, 1, 10, 0);
		addObject(13718, 2542, 4776, 1, 10, 0);
		addObject(14168, 2542, 4775, 1, 10, 0);
		addObject(2104, 2542, 4774, 1, 10, 0);

		addObject(409, 3085, 3508, 1, 10, 0);
		addObject(26258, 3085, 3511, 1, 10, 0);

		addObject(-1, 2529, 4764, 1, 10, 0);
		addObject(-1, 2528, 4764, 1, 10, 0);
		addObject(-1, 2525, 4764, 1, 10, 0);
		addObject(-1, 2524, 4764, 1, 10, 0);

		addObject(114, 2526, 4774, 1, 10, 0);

		addObject(2030, 2539, 4782, 1, 10, 0);
		addObject(2031, 2539, 4773, 1, 10, 0);
	}
	...
	public URL getCodeBase() {
		try {
			return new URL(Configuration.clientMode.getAddress() + ":"
					+ (80 + portOff));
		} catch (Exception _ex) {
		}
		return null;
		...
		try {
			...
			if (entity.anInt1517 != -1) {
				...
				if (entity.anInt1518 < animation.frameCount
					...
					entity.anInt1519 = 1;// this is the frame delay. 0 is what
											// it's
											// normally at. higher number =
											// faster
											// animations.
					entity.anInt1518++;
					entity.nextIdleAnimationFrame++;
				}
				entity.nextIdleAnimationFrame = entity.anInt1518 + 1; // go
			...
			if (entity.anim != -1 && entity.anInt1529 == 0) {
				...
				if (entity.anInt1527 >= animation_3.frameCount) {
					entity.anInt1527 -= animation_3.loopDelay;
					entity.anInt1530++;
	...
	private void drawGameScreen() {
		if (fullscreenInterfaceID != -1
			...
			if (loadingStage == 2) {
				...
				if (!menuOpen) {
					...
					drawMenu(Configuration.clientSize == 0 ? 4 : 0,
		...
		if (welcomeScreenRaised) {
			...
			tabAreaAltered = true;
			if (loadingStage != 2) {
				gameScreenIP.drawGraphics(
						Configuration.clientSize == 0 ? 4 : 0, super.graphics,
						Configuration.clientSize == 0 ? 4 : 0);
				if (Configuration.clientSize == 0)
		...
		if (backDialogID == -1) {
			...
			if (super.mouseX >= 496
					&& super.mouseX <= 511
					&& super.mouseY > (Configuration.clientSize == 0 ? 345
							: Configuration.clientHeight - 158))
				method65(494, 110, super.mouseX, super.mouseY
						- (Configuration.clientSize == 0 ? 345
								: Configuration.clientHeight - 158),
	...
	private void drawInterface(int j, int k, RSInterface class9, int l) {
		...
		for (int j2 = 0; j2 < i2; j2++) {
			...
			if (class9_1.type == 0) {
				...
				if (class9_1.type == 2) {
								...
								if (k5 > DrawingArea.topX - 32
									...
									Sprite class30_sub2_sub1_sub1_2 = ItemDef
											.getSprite(j9,
													...
													l9);
									if (class9_1.id >= 32212
											&& class9_1.id <= 32212 + 11) {
										if (class9_1.inv[i3] > 0) {
											if (class9_1.sprite2 != null) {
												class9_1.sprite2.drawSprite(k5
														+ k6 - 2, j6 + j7 - 2);
											}
										}
									}
									if (class30_sub2_sub1_sub1_2 != null) {
										...
										if (class9_1.id == RSInterface.selectedItemInterfaceId
											...
											for (int i = 32; i > 0; i--) {
												DrawingArea.method338(j6 + j7,
														i,
														256 - Byte.MAX_VALUE,
														0x395D84, i, k5 + k6);
											}
											DrawingArea.method338(j6 + j7, 32,
													256, 0x395D84, 32, k5 + k6);
										}
										if (class9_1.parentID < 58040
												|| class9_1.parentID > 58048) {
											if (class30_sub2_sub1_sub1_2.anInt1445 == 33
					...
					if (class9_1.id >= 58032 && class9_1.id <= 58040) {
						...
						try {
							tabId = Integer
									.parseInt(RSInterface.interfaceCache[5292].message);
					...
					if (class9.parentID == 49100 || class9.parentID == 51100
							|| class9.parentID == 53100) {
						int parent = class9.parentID == 49100 ? 49100
								: class9.parentID == 51100 ? 51100 : 53100;
						int subId = (class9_1.id - parent) % 100;
						if (subId > achievementCutoff) {
							continue;
						}
						if (class9_1.id - parent > 600
								&& class9_1.id - parent < 700) {
							String message = RSInterface.interfaceCache[class9_1.id + 100].message;
							if (message != null) {
								if (message.split("/").length == 2) {
									int currentValue = Integer.parseInt(message
											.split("/")[0]);
									if (currentValue <= 0) {
										sprite = new Sprite(
												"Interfaces/Achievements/IMAGE 6");
									} else {
										int maxValue = Integer.parseInt(message
												.split("/")[1]);
										...
										if (percentage <= 0.0)
											sprite = new Sprite(
													SignLink.findcachedir()
															+ "Sprites/Interfaces/Achievements/IMAGE 6.png",
													width, 16);
										else if (percentage <= 50.0)
											sprite = new Sprite(
													SignLink.findcachedir()
															+ "Sprites/Interfaces/Achievements/IMAGE 8.png",
													width, 16);
										else if (percentage <= 75.0)
											sprite = new Sprite(
													SignLink.findcachedir()
															+ "Sprites/Interfaces/Achievements/IMAGE 9.png",
													width, 16);
										else
											sprite = new Sprite(
													SignLink.findcachedir()
															+ "Sprites/Interfaces/Achievements/IMAGE 7.png",
													width, 16);
										sprite2 = new Sprite(
												"Interfaces/Achievements/IMAGE 6");
									}
			...
			if (class9_1.type == 12) {
				...
				drawInputField(class9_1, k, l, k2, l2, class9_1.width,
						class9_1.height);
				...
				for (int j11 = yPos + textDrawingArea_2.anInt1497 + 2; s2
					...
					if (class9_1.centerText) {
						textDrawingArea_2.method382(yPos, xPos + class9_1.width
								/ 2, s5, j11, false);
					} else {
						if (s5.contains("\\r")) {
							...
							int rightX = boxWidth + xPos
									- textDrawingArea_2.getTextWidth(text2) - 2;
	...
	private void method107(int i, int j, Stream stream, Player player) {
		...
		if ((i & 0x100) != 0) {
			...
			if (player.anInt1520 == 65535)
				player.anInt1520 = -1;
			try {
				if (Class36.animationlist[Integer
						.parseInt(
								Integer.toHexString(
										SpotAnim.cache[player.anInt1520].aAnimation_407.frameIDs[0])
										.substring(
												0,
												Integer.toHexString(
														SpotAnim.cache[player.anInt1520].aAnimation_407.frameIDs[0])
	...
	private void draw3dScreen() {
		...
		if (anInt1018 != -1) {
			...
			if (anInt1018 == 197 && Configuration.clientSize != 0) {
				drawInterface(0, Configuration.clientWidth - 567,
						RSInterface.interfaceCache[anInt1018], -80);
			} else if (anInt1018 == 201 && Configuration.clientSize != 0) {
				drawInterface(0, Configuration.clientWidth - 560,
						RSInterface.interfaceCache[anInt1018], -109);
			} else {
				drawInterface(0, Configuration.clientSize == 0 ? 0
						: (Configuration.clientWidth / 2) - 330,
						RSInterface.interfaceCache[anInt1018],
						Configuration.clientSize == 0 ? 0
								: (Configuration.clientHeight / 2) - 290);
			}
		}
		if (openInterfaceID != -1) {
			method119(anInt945, openInterfaceID);
			drawInterface(0, Configuration.clientSize == 0 ? 0
					: (Configuration.clientWidth / 2) - 356,
					RSInterface.interfaceCache[openInterfaceID],
					Configuration.clientSize == 0 ? 0
							: (Configuration.clientHeight / 2) - 230);
		}
		method70();
		if (anInt1055 == 1) {
			(Configuration.clientSize >= 1 ? cacheSprite[55] : multiOverlay)
					.drawSprite(
							Configuration.clientSize >= 1 ? Configuration.clientWidth - 39
									: 472, Configuration.clientSize >= 1 ? 175
									: 296);
		}
		if (!menuOpen) {
			processRightClick();
		...
		if (clientData) {
			...
			String[] columns = {
					"Fps: " + super.fps,
					"Width: " + Configuration.clientWidth,
					"Height: " + Configuration.clientHeight,
					"Mem: "
							+ (int) ((runtime.totalMemory() - runtime
									.freeMemory()) / 1024L) + "k",
					"Mouse X: " + super.mouseX + " , Mouse Y: " + super.mouseY,
					"Coords: " + x + ", " + y };
			int drawX = Configuration.clientSize == 0 ? 254
					: Configuration.clientHeight - 241;
			for (int i = 0; i < columns.length; i++, drawX += 15) {
				aTextDrawingArea_1271.method389(true, 5, 0xffff00, columns[i],
						anInt1104 == 0 ? drawX : drawX - 15);
			}
		}
		if (anInt1104 != 0) {
			int j = anInt1104 / 50;
			...
			j %= 60;
			if (j < 10) {
				aTextDrawingArea_1271.method389(true, 5, 0xffff00,
						"System update in: " + l + ":0" + j,
						Configuration.clientSize == 0 ? 329
								: Configuration.clientHeight - 166);
			} else {
				aTextDrawingArea_1271.method389(true, 5, 0xffff00,
	...
	private void determineMenuSize() {
		...
		if (Configuration.clientSize == 0) {
			...
			if (super.saveClickX > 0 && super.saveClickY > 0
					&& super.saveClickX < Configuration.clientWidth
					&& super.saveClickY < Configuration.clientHeight) {
				int i1 = super.saveClickX - 0 - i / 2;
				if (i1 + i > Configuration.clientWidth)
					i1 = Configuration.clientWidth - i;
				if (i1 < 0)
					i1 = 0;
				int l1 = super.saveClickY - 0;
				if (l1 + l > Configuration.clientHeight)
					l1 = Configuration.clientHeight - l;
				if (l1 < 0)
					l1 = 0;
				menuOpen = true;
				menuScreenArea = 0;
	...
	private void drawMinimap() {
		...
		if (anInt1021 == 2) {
			...
			cacheSprite[counterHover ? 22 : 23].drawSprite(
					(Configuration.clientSize == 0 ? 0
							: Configuration.clientWidth - 214),
					(Configuration.clientSize == 0 ? 20 : 10));
			if (loadOrbs)
				loadAllOrbs(Configuration.clientSize == 0 ? 0
						: Configuration.clientWidth - 217);
			compass.method352(33, minimapInt1, anIntArray1057, 256,
					anIntArray968, (Configuration.clientSize == 0 ? 25 : 24),
					4, (Configuration.clientSize == 0 ? 29
							: Configuration.clientWidth - 176), 33, 25);
			if (menuOpen) {
		...
		minimapImage.method352(151, i, anIntArray1229, 256 + minimapInt3,
				anIntArray1052, l2, (Configuration.clientSize == 0 ? 9 : 7),
				(Configuration.clientSize == 0 ? 52
						: Configuration.clientWidth - 157), 146, j);
		...
		DrawingArea.drawPixels(3, (Configuration.clientSize == 0 ? 83 : 80),
				(Configuration.clientSize == 0 ? 124
						: Configuration.clientWidth - 88), 0xffffff, 3);
		if (Configuration.clientSize == 0) {
			cacheSprite[19].drawSprite(0, 0);
		} else {
			cacheSprite[44].drawSprite(Configuration.clientWidth - 181, 0);
	...
	private void calcEntityScreenPos(int i, int j, int l) {
		...
		i1 = j2;
		if (l >= 50) {
			spriteDrawX = Texture.textureInt1
					+ (i << WorldController.viewDistance) / l;
			spriteDrawY = Texture.textureInt2
					+ (i1 << WorldController.viewDistance) / l;
		} else {
			spriteDrawX = -1;
			spriteDrawY = -1;
		}
	...
	public void drawLoginScreen(boolean flag) {
		...
		if (loginScreenState == 0) {
			...
			if ((this.mouseX >= 278) && (this.mouseX <= 493)
					&& (this.mouseY >= 207) && (this.mouseY <= 235)) {
				this.boxHover.drawSprite(279, 208);
			} else if ((this.mouseX >= 278) && (this.mouseX <= 470)
					&& (this.mouseY >= 261) && (this.mouseY <= 288)) {
				this.boxHover.drawSprite(280, 261);
			}

			if (Configuration.debug) {
				aTextDrawingArea_1271.method389(true, 15, 0xFFFFFF, "X: "
						+ this.mouseX + "", 60);
				aTextDrawingArea_1271.method389(true, 15, 0xFFFFFF, "Y: "
						+ this.mouseY + "", 80);
			}

			this.smallText.method382(16777215, 385, this.loginMessage1, 340,
					true);
			this.smallText.method382(16777215, 385, this.loginMessage2, 355,
					true);
			...
			if ((this.mouseX >= 293) && (this.mouseX <= 474)
				...
				this.loginHover.drawSprite(298, 299);
			}
		}
	...
	private void processLoginScreenInput() {
		if (this.loginScreenState == 0 || this.loginScreenState == 2) {
			resetImage();
			if (super.clickMode3 == 1 && super.saveClickX >= 278
					&& super.saveClickX <= 493 && super.saveClickY >= 207
					&& super.saveClickY <= 235)
				loginScreenCursorPos = 0;
			if (super.clickMode3 == 1 && super.mouseX >= 278
					&& super.mouseX <= 470 && super.mouseY >= 261
					&& super.mouseY <= 288)
		...
		try {
			...
			if (Configuration.clientSize == 0) {
				...
				sprite.drawSprite(((77 + k1) - sprite.anInt1444 / 2) + 4
						+ (Configuration.clientWidth - 167), 85 - l1
	...
	private boolean parsePacket() {
		...
		try {
			...
			case 134:
				...
				int newExperience = inStream.method439();
				int newSkillLevel = inStream.readUnsignedByte();
				if (skillID < currentExp.length) {
					xpCounter += (newExperience - currentExp[skillID]);
					if (currentExp[skillID] > -1) {
						addToXPCounter(skillID, newExperience
								- currentExp[skillID]);
					}
					currentExp[skillID] = newExperience;
					currentStats[skillID] = newSkillLevel;
					maxStats[skillID] = 1;
					for (int k20 = 0; k20 < 98; k20++)
						if (newExperience >= anIntArray1019[k20])
	...
	private void method146() {
		...
		if (!aBoolean1160) {
			...
			int zoom = (600 + (i * Configuration.clientHeight / 400));
			setCameraPos(cameraZoom
					+ (Configuration.clientWidth >= 1024 ? i + cameraZoom
							- Configuration.clientHeight / 200 : i)
					* (WorldController.viewDistance == 9
							&& Configuration.clientSize == 1 ? 1
							: WorldController.viewDistance == 10 ? 1 : 3), i,
					anInt1014, method42(plane, myPlayer.y, myPlayer.x) - 50, k,
					anInt1015);
		}
		if (!aBoolean1160)
			j = method120();
		...
		if (loggedIn) {
			...
			draw3dScreen();
			gameScreenIP.drawGraphics(Configuration.clientSize == 0 ? 4 : 0,
					super.graphics, Configuration.clientSize == 0 ? 4 : 0);
			xCameraPos = l;
			zCameraPos = i1;
			yCameraPos = j1;
			yCameraCurve = k1;
	...
	private void processMinimapActions() {
		...
		if (fixed ? super.mouseX >= 542 && super.mouseX <= 579
				...
				: super.mouseX >= Configuration.clientWidth - 180
						&& super.mouseX <= Configuration.clientWidth - 139
		...
		if (counterHover) {
			menuActionName[2] = counterOn ? "Toggle XP Display"
					: "Show XP Display";
			menuActionID[2] = 474;
		...
		if (poisoned || venom && loadOrbs) {
			menuActionName[1] = !isInfected ? "Poison On" : "Poison Off";
			menuActionID[1] = 1150;
			menuActionRow = 2;
		}
	...
	public boolean hpHover, prayHover, prayClicked, clickedQuickPrayers,
			runHover, xpHover, sumHover, sumActive, worldHover, starHover,
			xpLock, logHover, advHover, counterHover, Autocast, glowDownHp,
			glowDownPray, glowDownRun, resting, isInfected, runClicked,
			specialHover, poisoned, venom;
	...
	private void drawCounterOnScreen() {
		RSFont xp_font = newBoldFont;
		int font_height = 24;
		int x = Configuration.clientSize == 0 ? 500
				: Configuration.clientWidth - 200;
		int y = Configuration.clientSize == 0 ? 46 : 50;
		int lengthToRemove = Integer.toString(xpCounter).length();
		String text = NumberFormat.getIntegerInstance().format(xpCounter);
		cacheSprite[24].drawARGBSprite((Configuration.clientSize == 0 ? 386
				: Configuration.clientWidth - 335),
				(Configuration.clientSize == 0 ? 5 : 10), 200);
		sideIcons[1].drawSprite((Configuration.clientSize == 0 ? 390
				: Configuration.clientWidth - 332),
				(Configuration.clientSize == 0 ? 8 : 13));
		...
		smallText.method382(0xFFFFFF, (Configuration.clientSize == 0 ? 490
				: Configuration.clientWidth - 230) - i, text,
				(Configuration.clientSize == 0 ? 25 : 30), true);
			...
			if (xp_added[i][0] > -1) {
				if (xp_added[i][2] >= 0) {
					...
					for (int i2 = 0; i2 < skill_sprites.length; i2++) {
						...
						sprite.drawSprite(Configuration.clientSize == 0 ? x - a
								+ 17 - xp_font.getTextWidth(s) - icons_x_off
								: x - a + 0 - xp_font.getTextWidth(s)
										- icons_x_off, y + 10
								+ (140 - xp_added[i][2]) - (font_height / 2)
								- (sprite.myHeight / 2), transparency);
					}
					xp_font.drawBasicString(s,
							Configuration.clientSize == 0 ? x - a + 16
									- xp_font.getTextWidth(s) : x - a + -4
									- xp_font.getTextWidth(s), y + 10
	...
	public int specialOrb = 100;// PLACE HOLDER FOR NOW

	void loadSpecialOrb(int xOffset) {
		boolean isFixed = Configuration.clientSize == 0;
		Sprite image = cacheSprite[(specialHover ? 56 : 42)];
		Sprite fill = cacheSprite[5];
		Sprite sword = cacheSprite[55];
		image.drawSprite((isFixed ? 170 : 153) + xOffset, isFixed ? 122 : 148);
		fill.drawSprite((isFixed ? 174 : 156) + xOffset, isFixed ? 126 : 151);
		cacheSprite[5].myHeight = (int) (specialOrb * 27 / 100);
		cacheSprite[5].drawSprite((isFixed ? 174 : 156) + xOffset,
				isFixed ? 126 : 151);
		sword.drawSprite((isFixed ? 179 : 161) + xOffset, isFixed ? 131 : 156);
		smallText.method382(getOrbTextColor(specialOrb), (isFixed ? 212 : 195)
				+ xOffset, specialOrb + "", isFixed ? 148 : 175, true);
	}

	void loadPrayerOrb(int xOffset) {
		Sprite bg = cacheSprite[prayHover ? 7 : 6];
		Sprite fg = cacheSprite[prayClicked ? 2 : 1];
		bg.drawSprite(0 + xOffset, 85);
		fg.drawSprite(27 + xOffset, 89);
		int level = Integer.valueOf(RSInterface.interfaceCache[4012].message);
		int max = Integer.valueOf(RSInterface.interfaceCache[4013].message);
		double percent = level / (double) max;
		cacheSprite[5].myHeight = (int) (26 * (1 - percent));
		cacheSprite[5].drawSprite(27 + xOffset, 89);
		if (percent <= .25) {
			cacheSprite[9].drawARGBSprite(30 + xOffset, 92,
					200 + (int) (50 * Math.sin(loopCycle / 7.0)));
		} else {
			cacheSprite[9].drawSprite(30 + xOffset, 92);
		}
		smallText.method382(getOrbTextColor((int) (percent * 100)),
				16 + xOffset, String.valueOf(level), 111, true);
	}

	void loadRunOrb(int xOffset) {
		Sprite bg = cacheSprite[runHover ? 7 : 6];
		Sprite fg = cacheSprite[variousSettings[152] == 1 ? 4 : 3];
		bg.drawSprite(24 + xOffset, 122);
		fg.drawSprite(51 + xOffset, 126);
		int level = energy;
		double percent = level / (double) 100;
		cacheSprite[5].myHeight = (int) (26 * (1 - percent));
		cacheSprite[5].drawSprite(51 + xOffset, 126);
		if (percent <= .25) {
			cacheSprite[variousSettings[152] == 1 ? 11 : 10].drawARGBSprite(
					58 + xOffset, 130,
					200 + (int) (50 * Math.sin(loopCycle / 7.0)));
		} else {
			cacheSprite[variousSettings[152] == 1 ? 11 : 10].drawSprite(
					58 + xOffset, 130);
		}
		smallText.method382(getOrbTextColor((int) (percent * 100)),
				40 + xOffset, String.valueOf(level), 148, true);
	}

	void loadHpOrb(int xOffset) {
		Sprite bg = cacheSprite[6];
		bg.drawSprite(0 + xOffset, 41);
		cacheSprite[0].drawSprite(27 + xOffset, 45);
		int level = Integer.valueOf(RSInterface.interfaceCache[4016].message);
		int max = Integer.valueOf(RSInterface.interfaceCache[4017].message);
		double percent = level / (double) max;
		cacheSprite[5].myHeight = (int) (26 * (1 - percent));
		cacheSprite[5].drawSprite(27 + xOffset, 45);
		if (percent <= .25) {
			cacheSprite[8].drawARGBSprite(33 + xOffset, 52,
					200 + (int) (50 * Math.sin(loopCycle / 7.0)));
		} else {
			cacheSprite[8].drawSprite(33 + xOffset, 52);
		}
		smallText.method382(getOrbTextColor((int) (percent * 100)),
				15 + xOffset, String.valueOf(level), 67, true);
	}
	...
	private void loadAllOrbs(int xOffset) {
		...
		int[] orbX = { 0, 0, 24 }, orbY = { 41, 85, 122 }, orbTextX = { 16, 16,
				40 }, orbTextY = { 68, 112, 149 }, coloredOrbX = { 27, 27, 51 }, coloredOrbY = {
				45, 89, 126 }, currentInterface = { 4016, 4012, 149 }, maximumInterface = {
				4017, 4013, 149 }, orbIconX = { 33, 30, 58 }, orbIconY = { 52,
				92, 130 };
		int[] spriteID = { isInfected && hpHover ? 8 : 7, prayHover ? 8 : 7,
				runHover ? 8 : 7, sumActive && sumHover ? 8 : 7 }, coloredOrbSprite = {
				0, clickedQuickPrayers ? 2 : 1, runClicked ? 4 : 3,
				sumActive ? 6 : 5 }, orbSprite = { 9, 10,
				(runClicked ? 12 : 11), 13 };
		String cEnergy = RSInterface.interfaceCache[149].message.replaceAll(
				"%", "");
		String hp = RSInterface.interfaceCache[4016].message
				.replaceAll("%", "");
		...
		if (Configuration.clientSize == 0) {
			...
			cacheSprite[worldHover ? 52 : 51].drawSprite(
					Configuration.clientWidth - 118, 154);
		}
	}
	...
	private void drawInputField(RSInterface child, int interfaceX,
			int interfaceY, int x, int y, int width, int height) {
		...
		for (int row = 0; row < width; row += 12) {
			if (row + 12 > width)
				row -= 12 - (width - row);
			inputSprites[6].drawSprite(xModification <= 0 ? x + row : x
					+ xModification, y);
			for (int collumn = 0; collumn < height; collumn += 12) {
				if (collumn + 12 > height)
					collumn -= 12 - (height - collumn);
				inputSprites[6].drawSprite(x + row, yModification <= 0 ? y
						+ collumn : y + yModification);
			}
		}
					...
					.method389(
							...
							new StringBuilder()
									...
									.append(((!child.isInFocus ? 0 : 1) & (loopCycle % 40 < 20 ? 1
											: 0)) != 0 ? "|" : "").toString(),
							(y + (height / 2) + 6));
		if (clickX >= x && clickX <= x + child.width && clickY >= y
				&& clickY <= y + child.height) {
			if (!child.isInFocus && getInputFieldFocusOwner() != child) {
				if ((super.clickMode2 == 1 && !menuOpen)) {
					...
					if (child.message != null
							&& child.message
									.equals(child.defaultInputFieldText))
						child.message = "";
					if (child.message == null)
						child.message = "";
				}

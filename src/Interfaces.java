public class Interfaces extends RSInterface {
	...
	public static void questTab(TextDrawingArea[] TDA) {
		...
		addText(29161, " AbyssalPS", 0xFF981F, false, true, 22, TDA, 1);
		addHoverText(29162, "", "View Progress", TDA, 0, 0xff0000, false, true,
				150);
		addHoverText(29163, "Players Online", "View Progress", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29164, "Server Information", "View Progress", TDA, 0,
				0xff0000, false, true, 150);
		...
		addHoverText(29305, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29306, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29307, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29308, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29309, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29310, "Medium Tasks", "View Achievements", TDA, 0,
				0xFF981F, false, true, 150);
		addHoverText(29311, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29314, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29312, "Hard Tasks", "View Achievements", TDA, 0,
				0xFF981F, false, true, 150);
		addHoverText(29313, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29315, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
		addHoverText(29316, "        Task", "View Achievements", TDA, 0,
				0xff0000, false, true, 150);
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, 1, 0, 1, 30012, 30006,
				68, "Training Teleports", "Teleports you to moonclan island",
				TDA, 6, 0, 5);
		...
		addLunar3RunesSmallBox(30083, 9075, 563, 557, 1, 0, 5, 30012, 30006,
				70, "Pking Teleports", "Teleports you to ourania rune altar",
				TDA, 8, 0, 5);
		addLunar3RunesSmallBox(30091, 9075, 564, 563, 1, 1, 0, 30013, 30012,
				70, "Skilling Area", "Cures Poison", TDA, 9, 0, 5);
	...
	private static void spawnInterface(TextDrawingArea[] tda) {
		...
		addHoverButton(55102, "interfaces/spawn/sprite", 1, 16, 16,
		...
		addToItemGroup(55121, 8, 80, 25, 10, true, "Buy 1", "Buy 5", "Buy 10",
				"Buy 50", "Buy X");
	...
	public static void addToItemGroup(int childId, int w, int h, int x, int y,
			boolean actions, String action1, String action2, String action3,
			String action4, String action5) {
